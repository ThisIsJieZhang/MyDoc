...
browser.define("browser.qb.wxAuth", function(succCallback) {
  x5.exec(succCallback, null, "qb", "wxAuth", []);
});browser.define("browser.qb.webpageFeedbackReport", function(succCallback, options){
	x5.exec(succCallback, null, "qb", "webpageFeedbackReport", options ? [options] : []);
});browser.define("browser.qb.getTencentVideoLoginState", function(succCallback, options){
	x5.exec(succCallback, null, "qb", "getTencentVideoLoginState", options ? [options] : []);
...
});browser.define("browser.qb.addShortcutAccessRecord", function (options, callback) {
  x5.exec(callback, null, "qb", "addShortcutAccessRecord", [options]);
});browser.define("browser.qb.addToShortcut", function (options, callback) {
  x5.exec(callback, null, "qb", "addToShortcut", [options]);
});browser.define("browser.qb.removeFromShortcut", function (options, callback) {
  x5.exec(callback, null, "qb", "removeFromShortcut", [options]);
});browser.define("browser.qb.setDefaultHomeTab", function (options, callback) {
  x5.exec(callback, null, "qb", "setDefaultHomeTab", [options]);
});browser.define("browser.qb.mmaOnExpose", function(options){
   x5.exec(null,null,"qb","mmaOnExpose",options ? [options] : []);
});browser.define("browser.qb.mmaOnClick", function(options){
   x5.exec(null,null,"qb","mmaOnClick",options ? [options] : []);
});browser.define("browser.qb.getToolBoxHistoryList", function(options, callback){
	x5.exec(callback, null, "qb", "getToolBoxHistoryList", [options]);
});browser.define("browser.qb.batchQueryShortcutsState", function (options, callback) {
  x5.exec(callback, null, "qb", "batchQueryShortcutsState", [options]);
});
